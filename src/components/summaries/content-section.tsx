...
const EmojiPoint = ({ point }: { point: string }) => {
  ...
  return (
    <div className="group relative bg-linear-to-br from-gray-200/[0.08] to-gray-400/[0.03] rounded-2xl p-4 border border-gray-500/10 hover:shadow-lg transition-all">
