...
const LoadingSkeleton = () => {
  return (
    <Card className="relative px-2 h-[700px] w-[600px] max-w-lg mx-auto overflow-hidden bg-linear-to-r from-background via-background/95 to-rose-500/5 backdrop-blur-lg shadow-2xl rounded-3xl border border-rose-500/10">
        ...
        <div className="px-6">
          ...
          <div className="space-y-4">
            ...
            {[1, 2, 3].map((_, index) => (
              <div
                key={`numbered-${index}`}
                className="group relative bg-linear-to-r from-gray-500/[0.08] to-gray-600/[0.03] p-4 rounded-2xl border border-gray-500/10"
              >
            ...
            {[1, 2].map((_, index) => (
              <div
                key={`emoji-${index}`}
                className="group relative bg-linear-to-r from-gray-200/[0.08] to-gray-400/[0.03] p-4 rounded-2xl border border-gray-500/10"
              >
