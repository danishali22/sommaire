      ...
      <div className="py-12 lg:py-24 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 lg:pt-12">
        ...
        >
          <div
            ...
            style={{
              clipPath:
                "polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1% 80.7% 2%, 72.5% 32.5%, 60.24% 62.4% 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)",
            }}
          />
        </div>
        <div className="text-center mb-16">
          ...
          <MotionH3
            ...
            className="font-bold text-3xl max-2-xl mx-auto"
          >
            ...
            >
              ...
              {index < steps.length - 1 && (
                <MotionDiv
                  ...
                  className="hidden md:block absolute top-1/2 -right-4 transform translate-4-1/2 z-10"
                >
                  <MoveRight
                    size={32}
                    strokeWidth={1}
